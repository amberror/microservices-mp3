...
public class KafkaConfig {
	...
	@Bean
	public ConsumerFactory<String, Long> resourceConsumerFactory(
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Long> resourceKafkaListenerContainerFactory(ConsumerFactory<String, Long> resourceConsumerFactory) {
